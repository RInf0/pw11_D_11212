        ...
        <div className="p-5">
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                ...
                <div className="col-md-6 d-flex justify-content-start">
                    <p className="text-start mt-4 ms-3">{message} message</p> </div>
                </div>
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                ...
                <div className="col-md-6 d-flex justify-content-start">
                    <p className="text-start mt-4 ms-3">Kata yang simpan : {message2}</p> </div>
                </div>
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                <div className="col-md-6">
                    ...
                    <input
                        type="text"
                        placeholder="Jika tidak diisi maka button akan disable" className="form-control"
                        id="Input2"
